...
class IncidentsControllerTest < ActionController::TestCase
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post :create, incident: { attendee_id: @incident.attendee_id, camp_id: @incident.camp_id, incident: @incident.incident }
    end
  ...
  test "should update incident" do
    patch :update, id: @incident, incident: { attendee_id: @incident.attendee_id, camp_id: @incident.camp_id, incident: @incident.incident }
    assert_redirected_to incident_path(assigns(:incident))
  end
