...
class CampsControllerTest < ActionController::TestCase
  ...
  test "should create camp" do
    assert_difference('Camp.count') do
      post :create, camp: { end_date: @camp.end_date, name: @camp.name, speaker: @camp.speaker, start_date: @camp.start_date, theme: @camp.theme }
    end
  ...
  test "should update camp" do
    patch :update, id: @camp, camp: { end_date: @camp.end_date, name: @camp.name, speaker: @camp.speaker, start_date: @camp.start_date, theme: @camp.theme }
    assert_redirected_to camp_path(assigns(:camp))
  end
